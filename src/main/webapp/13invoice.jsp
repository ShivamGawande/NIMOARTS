                ...
                <table class="table table-hover">
                    ...
                    <tbody>
                        <tr>
                            <td>
                                <div class="media">
                                    <img class="mr-3 img-fluid" src="img/11.png" alt="Product 01">
                                    <div class="media-body">
                                        <p class="mt-0 title">Om Wall Decoration </p>
                                        Size :- 2.5*2.5 foot , Category :Decoration 
                                    </div>
                                </div>
                            </td>
                            <td>11,500 RS  </td>
